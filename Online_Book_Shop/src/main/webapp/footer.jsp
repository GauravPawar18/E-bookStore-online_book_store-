        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">BookStore</h2>
            ...
            <div class="ftco-footer-widget mb-3">
            	...
            	<div class="block-23 mb-2">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+919028021101</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">bookStoreproject@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
